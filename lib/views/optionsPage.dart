...
class _OptionsPageState extends State<OptionsPage> {
  ...
  // void initCount(DrinksOptions drinksOptions){
  //   setState(() {
  //     if(drinksOptions.getOptions.length >= 1){
  //       for(int i=0;i<drinksOptions.getOptions.length;i++){
  //         if(drinksOptions.getOptions[i]['id'] == widget.childrenItem['Id']){
  //           count = drinksOptions.getOptions[i]['count'];
  //           allCount = drinksOptions.getOptions[0]['allCount'];
  //           print('初始化的allCount $allCount');
  //         }
  //       }
  //     }
  //   });
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: (){
                                setState(() {
                                  count += 1;
                                  //添加饮料
                                  if(drinksOptions.getOptions != null){
                                    pushData(changeIcon);
                                    ...
                                    throw 'stateManage.dart 的 DrinksOptions为空';
                                  }
                                });
                              },
                              child: Text('加入购物车',style: TextStyle(fontSize: 12),),
                            ),
                          ),),
                        ],
                      ),
                        ...
                        GestureDetector(
                          onTap: (){
                            setState(() {
                              ...
                              //减少饮料
                              if(drinksOptions.getOptions != null){
                                // pushData(count,changeIcon);
                                drinksOptions.addAllCount(false, double.parse(widget.childrenItem['Price'].toString()));
                                // print('添加饮料:${drinksOptions.getOptions}');
                                print('饮料合计:${drinksOptions.getAllData}');
                              }else{
                                throw 'stateManage.dart 的 DrinksOptions为空';
